package iducs.java.pim201812045.controller;

import iducs.java.pim201812045.model.Member;
import iducs.java.pim201812045.service.MemberService;
import iducs.java.pim201812045.service.MemberServiceImpl;
import iducs.java.pim201812045.view.MemberView;
import iducs.java.pim201812045.view.TUIView;
...
public class MemberController {
    ...
    final String MemberDB = "db201812045.txt";
    ...
    public void dispatch() {
        ...
        do {
            ...
            if (sessionMember != null) {
                isLogin = true;
                if (sessionMember.getEmail().toString().equals("admin201812045@induk.ac.kr"))
                    isRoot = true;
            } else {
                isLogin = false;
                isRoot = false;
            ...
            switch (menu) {
                ...
                case 1: // 등록
                    ...
                    if(memberService.postMember(member) > 0)
                        memberService.applyUpdate(member);
                    else
